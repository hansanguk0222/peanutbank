...
const StyledButton = styled.button<ButtonStyleProps>`
  ...
  ${(props) =>
    ...
    css<ButtonStyleProps>`
      background: ${(props) =>
        !props.isSelected ? props.theme.color.darkBlue1 : props.theme.color.darkBlue2};
      ...
      &:hover {
        ...
        &:before {
          ...
          top: 0;
          left: 0;
          border-left: ${(props) => props.theme.size.border.BorderRightleftSideBarItem} solid
            ${(props) => props.theme.color.jade};
          border: 2px solid;
